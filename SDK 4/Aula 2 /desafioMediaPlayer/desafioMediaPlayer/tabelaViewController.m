...
- (void)viewDidLoad
{
    ...
    self.arrayConteudoDaTabela = @[@"Video"];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [self.arrayConteudoDaTabela count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [self.arrayConteudoDaTabela objectAtIndex:indexPath.row];
...
{
    if (indexPath.row == 0) {
        NSLog(@"Clicou em Vídeo");
        
        //Criando a view do video
        UIViewController *viewDoVideo;
        viewDoVideo = [[UIViewController alloc]init];
        
        //Criando o caminho ateh o arquivo
        ...
        //Iniciando o objeto que controlará o video
